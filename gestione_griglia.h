...
void applica_difficolta_griglia(char griglia[MAX_DIM][MAX_DIM], int righe, int colonne, int livello);    // in base al livello scelto , mi oscura il numero delle parole
...
int riga_e_completata(char griglia[MAX_DIM][MAX_DIM], int riga_da_controllare, int num_colonne);      // NUOVA FUNZIONE: Controlla se una singola riga è già finita
